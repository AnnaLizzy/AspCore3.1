        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Decreption = table.Column<string>(maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginPrice = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 200, nullable: false),
                    SeoDescription = table.Column<string>(maxLength: 200, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Decreption", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "0ead6e18-2297-4351-8ca2-49eb7b42db5b", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "24d5af0d-5d2f-4b98-8d28-b9c8eca08624", new DateTime(2000, 3, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin.default@gmail.com", true, "Anna", "Serein", false, null, "admin.default@gmail.com", "admin", "AQAAAAEAACcQAAAAEOFOBi6WuhTZ4bfEmh3sJ2HKu4UJpSpmiiF3NJzxsq4wpKCybGZWUjHTt36AGiM6ZQ==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "IsFeatured", "OriginPrice", "Price" },
                values: new object[] { 1, new DateTime(2022, 9, 24, 13, 17, 49, 72, DateTimeKind.Local).AddTicks(6753), null, 100000m, 200000m });
